    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col pt-4 pb-2">
                <button class="btn btn-primary me-2 productCreateForm" form="productCreateForm">Save</button>
                <a class="btn btn-outline-primary cancel" href="{{ route('products.create') }}">Cancel</a>
            </div>
