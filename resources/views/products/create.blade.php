...
{{--                                product name--}}
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control  @error('name') is-invalid @enderror" name="name" placeholder="Please Product Name" id="name" value="{{old('name')}}">
                                    @error('name')
...
{{--                                    <textarea name="highlight" class="form-control form- @error('highlight') is-invalid @enderror" id="" cols="30" rows="3">@if(old('highlight')) {{old('highlight')}} @else Please hightlight information @endif </textarea>--}}
                                    <textarea name="highlight" class="form-control form- @error('highlight') is-invalid @enderror" id="" cols="30" rows="2">{{old('highlight')}}</textarea>
...
{{--                                product code--}}
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control  @error('productCode') is-invalid @enderror" name="productCode" placeholder="Please Enter Product Code" id="productCode" value="{{old('productCode')}}">
                                    @error('productCode')
                                    <div class="invalid-feedback">
                                        <span>{{$message}}</span>
                                    </div>
...
{{--                                ordering--}}
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control  @error('ordering') is-invalid @enderror" name="ordering" placeholder="Ordering" id="ordering" value="{{old('ordering')}}">
                                    @error('ordering')
                                    <div class="invalid-feedback">
                                        <span>{{$message}}</span>
                                    </div>
...
{{--                             ingredient   --}}
                                <div class="col">
                                    ...
                                    <textarea name="ingredient" class="form-control form- @error('ingredient') is-invalid @enderror" id="" cols="30" rows="4">{{old('ingredient')}}</textarea>
...
{{--                                nutrient--}}
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control  @error('nutrient') is-invalid @enderror" name="nutrient" placeholder="Nutrient" id="nutrient" value="{{old('nutrient')}}">
                                    @error('nutrient')
                                    <div class="invalid-feedback">
                                        <span>{{$message}}</span>
                                    </div>
...
{{--                                product dynamic link--}}
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control  @error('product_dynamic_link') is-invalid @enderror" name="product_dynamic_link" placeholder="" id="product_dynamic_link" value="{{old('product_dynamic_link')}}">
...
{{--                                Original Price--}}
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control  @error('original_price') is-invalid @enderror" name="original_price" placeholder="0" id="original_price" value="{{old('original_price')}}">
...
{{--                                Min Order--}}
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control  @error('min_order') is-invalid @enderror" name="min_order" placeholder="Please Minimun Order" id="min_order" value="{{old('min_order')}}">
                                    @error('min_order')
                                    <div class="invalid-feedback">
                                        <span>{{$message}}</span>
                                    </div>
...
{{--                                Max Order--}}
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control  @error('max_order') is-invalid @enderror" name="max_order" placeholder="Please Maximum Order" id="max_order" value="{{old('max_order')}}">
                                    @error('max_order')
                                    <div class="invalid-feedback">
                                        <span>{{$message}}</span>
                                    </div>
...
{{--                                Product Unit Value--}}
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control  @error('product_unit_value') is-invalid @enderror" name="product_unit_value" placeholder="Please provide product unit value" id="product_unit_value" value="{{old('product_unit_value')}}">
...
{{--                                Prd Unit--}}
                                <div class="col">
                                    ...
                                    <input type="string" class="form-control  @error('prd_unit') is-invalid @enderror" name="prd_unit" placeholder="Please product unit " id="prd_unit" value="{{old('prd_unit')}}">
                                    @error('prd_unit')
                                    <div class="invalid-feedback">
                                        <span>{{$message}}</span>
                                    </div>
...
{{--                                Search/Tag keyword--}}
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control  @error('search_keyword') is-invalid @enderror" name="search_keyword" placeholder="Please Search Tag" id="search_keyword" value="{{old('search_keyword')}}">
...
{{--                                product Description--}}
                                <div class="col">
                                    ...
                                    <textarea name="description" class="form-control form- @error('description') is-invalid @enderror" id="" cols="30" rows="4">{{old('description')}}</textarea>
...
{{--                                    <input type="file" class="form-control" name="image"  accept="image/jpeg,image/png">--}}
                                    <input type="file" id="image" name="photo" class=" form-control @error('photo') is-invalid @enderror" accept="photo/jpeg,photo/png">
                                    @error('photo')
                                    <div class="invalid-feedback">
